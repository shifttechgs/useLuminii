            ...
            <div class="lp-ftabs__nav">
                ...
                <button class="lp-ftabs__btn" data-tab="ops">
                    <div class="lp-ftabs__btn-inner">
                        ...
                        <span>Schedule, track, and manage without the chaos.</span>
                    </div>
                </button>
                    ...
                    <div class="lp-ftabs__panel-card">
                        ...
                        <div class="lp-ftabs__mini-grid">
                            <div class="lp-ftabs__mini-card">
                                ...
                                <strong>Smart Website</strong>
                                <span>SEO-optimised, mobile-first, built to convert visitors into leads.</span>
                            </div>
                            <div class="lp-ftabs__mini-card">
                                <i class="ph ph-star"></i>
                                <strong>Google Reviews</strong>
                                <span>Auto-request 5-star reviews after every completed job.</span>
                            </div>
                            <div class="lp-ftabs__mini-card">
                                <i class="ph ph-envelope-simple"></i>
                                <strong>Email Campaigns</strong>
                                <span>Nurture past clients with automated seasonal offers.</span>
                            </div>
                            <div class="lp-ftabs__mini-card">
                        ...
                        <a href="{{ url('/') }}#booking" class="lp-btn lp-btn--primary lp-btn--sm">
                            Book a Demo <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="lp-ftabs__panel-card">
                        ...
                        <div class="lp-ftabs__mini-grid">
                            ...
                            <div class="lp-ftabs__mini-card">
                                ...
                                <strong>Full CRM</strong>
                                <span>Every lead, conversation, and follow-up in one place.</span>
                            </div>
                            <div class="lp-ftabs__mini-card">
                            ...
                            <div class="lp-ftabs__mini-card">
                                ...
                                <span>Branded quotes in 2 min. Online approval. Auto follow-ups.</span>
                            </div>
                        </div>
                    ...
                    <div class="lp-ftabs__panel-card">
                        ...
                        <div class="lp-ftabs__mini-grid">
                            <div class="lp-ftabs__mini-card">
                                ...
                                <span>Drag-drop calendar. Auto-assign. Customer notifications.</span>
                            </div>
                            <div class="lp-ftabs__mini-card">
                                <i class="ph ph-map-pin"></i>
                                <strong>GPS Tracking</strong>
                                <span>Know where your team is. Optimise routes. Save fuel.</span>
                            </div>
                            <div class="lp-ftabs__mini-card">
                                <i class="ph ph-users-three"></i>
                                <strong>Team Management</strong>
                                <span>Unlimited users. Role-based access. No per-seat fees.</span>
                            </div>
                            <div class="lp-ftabs__mini-card">
                    ...
                    <div class="lp-ftabs__panel-card">
                        ...
                        <div class="lp-ftabs__mini-grid">
                            <div class="lp-ftabs__mini-card">
                                ...
                                <strong>Auto Invoicing</strong>
                                <span>Invoice on completion. Online payments. Auto reminders.</span>
                            </div>
                            <div class="lp-ftabs__mini-card">
                                <i class="ph ph-wallet"></i>
                                <strong>Expense Tracking</strong>
                                <span>Know your true margin per job. No surprises at month-end.</span>
                            </div>
                            <div class="lp-ftabs__mini-card">
                                <i class="ph ph-bank"></i>
                                <strong>SARS Compliance</strong>
                                <span>VAT-ready invoicing. Income reports for your accountant.</span>
                            </div>
                            <div class="lp-ftabs__mini-card">
