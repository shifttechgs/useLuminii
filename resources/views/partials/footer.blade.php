        ...
        <div class="row newsletter-wrap primary-bg rounded shadow-lg p-5">
            <div class="col-md-6 col-lg-7 mb-4 mb-md-0 mb-sm-4 mb-lg-0">
                <div class="newsletter-content text-white">
                    <h3 class="mb-0 text-white">Join the waiting list</h3>
                    <p class="mb-0">Get a 20% Discount on Your First Month!</p>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-7">
                <div class="copyright-wrap small-text">
                    <p class="mb-0">&copy; lumini<span style="color: rgb(255 196 20);">i</span>, All rights reserved. Designed By ShiftTech</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-5">
