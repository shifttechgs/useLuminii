...
mmm.add("(max-width: 991px)", () => {
  ...
  // Create fresh timeline for mobile menu
  mtl = gsap.timeline({paused: true});
  ...
  if (!mobileMenuInitialized && toggleMobileMenu && closeButton && mobileSideOverlay) {
    mobileMenuInitialized = true;

    toggleMobileMenu.addEventListener('click', function (e) {
      e.stopPropagation();
      mtl.play();
    ...
    closeButton.addEventListener('click', function (e) {
      ...
      mtl.reverse().eventCallback("onReverseComplete", function() {
        // Ensure overlay is fully hidden
    ...
    mobileSideOverlay.addEventListener('click', function (e) {
      e.stopPropagation();
      mtl.reverse().eventCallback("onReverseComplete", function() {
        // Ensure overlay is fully hidden
        if (mobileSideOverlay) {
